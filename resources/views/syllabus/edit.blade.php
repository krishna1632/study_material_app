                        ...
                        <div class="col-md-6">
                            ...
                            <select name="subject_type" id="subject_type" class="form-control" required>
                                ...
                                @foreach ($subjectTypes as $type)
                                    <option value="{{ $type }}" {{ $type == $syllabus->subject_type ? 'selected' : '' }}>{{ $type }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="department" id="department" class="form-control">
                                ...
                                @foreach ($departments as $dept)
                                    <option value="{{ $dept }}" {{ $dept == $syllabus->department ? 'selected' : '' }}>{{ $dept }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-md-6 mt-3">
                            ...
                            <select name="semester" id="semester" class="form-control" required>
                                ...
                                @foreach ($semesters as $semester)
                                    <option value="{{ $semester }}" {{ $semester == $syllabus->semester ? 'selected' : '' }}>{{ $semester }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-md-6 mt-3">
                            ...
                            <select name="subject_name" id="subject" class="form-control" required>
                                ...
                                @foreach ($subjects as $subject)
                                    <option value="{{ $subject }}" {{ $subject == $syllabus->subject_name ? 'selected' : '' }}>{{ $subject }}</option>
                                @endforeach
                            </select>
                        </div>
